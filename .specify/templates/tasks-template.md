...
**Verification**: Each user story MUST include automated tests or a justified
manual verification task. Automated tests are required for repeatable contract,
integration, data, and business-rule behavior when the project test stack
supports them.
...
- [ ] T010 Define feature verification commands and quality gates from plan.md
...
> **NOTE**: Write automated tests first where applicable and ensure they fail
> before implementation. If verification is manual, cite the plan justification.
...
- [ ] T013 [US1] Verification task for [manual or automated check] documented in plan.md
...
- [ ] T022 [US2] Verification task for [manual or automated check] documented in plan.md
...
- [ ] T029 [US3] Verification task for [manual or automated check] documented in plan.md
...
- [ ] TXXX Run all verification commands and record results
...
- Manual verification tasks MUST cite the plan justification for not automating
...
- Verify automated tests fail before implementing when automated tests are used
- Include a verification task for every delivered user story
